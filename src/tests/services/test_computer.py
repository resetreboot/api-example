...
from services.computer import list, create, update, delete
from tests.factories import create_computer


def test_create_ok():
    with patch('services.computer.create') as mock:
        ok, data, errors = create("Spectrum", )
